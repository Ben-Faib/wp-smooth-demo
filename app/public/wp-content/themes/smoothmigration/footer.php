              ...
              <div class="col-md-3">
                ...
                <ul class="footer-links">
                  <?php if ( has_nav_menu( 'footer_categories' ) ) : ?>
                    ...
                    ?>
                  <?php else : ?>
                    <li><a href="/service-type/money-services/" class="footer-link">Money Services</a></li>
                    ...
                    <li><a href="/service-type/telecommunication/" class="footer-link">Phone Plans</a></li>
                  <?php endif; ?>
                </ul>
              </div>
