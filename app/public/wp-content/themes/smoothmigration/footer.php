    ...
    <div class="row g-4 align-items-start">
      <div class="col-lg-5">
        <div class="footer-brand">
          ...
          <p class="footer-description">Making international relocation smooth and stress-free for expats worldwide.</p>
        </div>
      </div>
        ...
        <div class="footer-social">
          ...
          <a href="#" class="social-link" aria-label="X">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d="M18.244 2H21l-6.51 7.44L22.5 22h-5.94l-4.24-5.56L6.3 22H3.54l6.98-7.98L2.5 2h6.06l3.78 5.04L18.24 2zm-.99 18h1.98L8.83 4H6.85l10.4 16z"/>
            </svg>
          </a>
