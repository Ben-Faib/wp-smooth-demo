            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="form-container">
                        ...
                        <form class="partner-application-form" id="partnerApplicationForm">
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" name="description" rows="4" required placeholder="Tell us about your business, specialties, and why you'd be a great partner..."></textarea>
                                    </div>
                                </div>
