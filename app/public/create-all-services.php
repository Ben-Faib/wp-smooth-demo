...
<p><strong>Loyalty Program:</strong> Earn points on every transfer and get discounts on future transactions.</p>',
    ...
    'telecommunication' => array(
        array(
            'title' => 'Verizan International Mobile Plans',
            'content' => '<h2>Verizan - Global Connectivity Solutions</h2>
<p>Verizan offers comprehensive international mobile plans designed for expatriates and frequent travelers.</p>
<h3>Plan Features:</h3>
<ul>
...
<p><strong>Expat Special:</strong> First 3 months at 50% off for new international customers.</p>',
            'excerpt' => 'Comprehensive international mobile plans from Verizan with unlimited roaming and global connectivity.',
            'price' => 'From $89/month',
            'duration' => '1-3 days activation'
        ),
        array(
            'title' => 'AT&Tea Global Communications',
            'content' => '<h2>AT&Tea - Your Global Communication Partner</h2>
<p>AT&Tea provides business-grade communication solutions for international companies and remote workers.</p>
